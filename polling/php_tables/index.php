<?
	...
	$json_string = '
		...
		[
			...
			["THERM2D","THERMS: JACK MANFRED MANN",[["1||2","TOTAL FAV"],["3||4", "TOTAL UNFAV"], ["(1||2) -(3||4)", "TOTAL FAV - TOTAL UNFAV"],[1,"VERY FAVORABLE"],[2,"SOMEWHAT FAVORABLE"],[3,"SOMEWHAT UNFAVORABLE"],[4,"VERY UNFAVORABLE"],[5,"NO OPINION/NEUTRAL"],[6,"NEVER HEARD"],[7,"DK/NR"]]],
			...
			[["GOVVOTE, GOVLEAN"],"GOVERNOR RACE", [["GOVVOTE ==1","BB KING"], ["GOVLEAN == 1", "LEAN BB KING"], ["GOVVOTE == 2", "JEFFREY GRAGG"], ["GOVLEAN == 2", "LEAN MANFRED MANN"], ["GOVVOTE == 3 && GOVLEAN == 3", "UNDECIDED"], ["GOVVOTE == 1 || GOVLEAN == 1", "TOTAL BB KING"], ["GOVVOTE == 2 || GOVLEAN == 2", "TOTAL MANFRED MANN"], ["(GOVVOTE == 1 || GOVLEAN == 1) - (GOVVOTE == 2 || GOVLEAN == 2)", "TOTAL MARKELL - CRAGG"]]],
			[["VOTE1,VOTE1B"], "INITIAL VOTE", [["VOTE1 == 1","MICK JAGGER"], ["VOTE1B == 1", "LEAN MICK JAGGER"], ["VOTE1 == 2", "PETE TOWNSEND"], ["VOTE1B == 2", "LEAN PETE TOWNSEND"], ["VOTE1 == 3 && VOTE1B == 3", "UNDECIDED"], ["VOTE1 == 1 || VOTE1B == 1", "TOTAL MICK JAGGER"], ["VOTE1 == 2 || VOTE1B == 3", "TOTAL PETE TOWNSEND"], ["(VOTE1 ==1 || VOTE1B == 1) - (VOTE1 == 2 || VOTE1B == 2)", "TOTAL MCGINN - KING"]]],
			[["VOTEBIO,VOTEBIO2"], "INFORMED BIO VOTE", [["VOTEBIO == 1","MICK JAGGER"], ["VOTEBIO2 == 1", "LEAN MICK JAGGER"], ["VOTEBIO == 2", "PETE TOWNSEND"], ["VOTEBIO2 == 2", "LEAN PETE TOWNSEND"], ["VOTEBIO == 3 && VOTEBIO2 == 3", "UNDECIDED"], ["VOTEBIO == 1 || VOTEBIO2 == 1", "TOTAL MICK JAGGER"], ["VOTEBIO == 2 || VOTEBIO2 == 3", "TOTAL PETE TOWNSEND"], ["(VOTEBIO ==1 || VOTEBIO2 == 1) - (VOTEBIO == 2 || VOTEBIO2 == 2)", "TOTAL MCGINN - KING"]]],
